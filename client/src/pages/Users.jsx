...
class Users extends Component {
    ...
    componentDidMount() {
        axios.get('https://node-auth.aharrison.xyz/api/users/').then(({ data }) => this.setState({ users: data }));
        axios.get('https://node-auth.aharrison.xyz/api/auth/me', {
            headers: {
    ...
    deleteUser = id => {
        ...
        axios.delete('https://node-auth.aharrison.xyz/api/users/' + id, {
            headers: {
                'x-access-token': cookie.load('x-access-token')
            }
        }).then(({ data }) => axios.get('https://node-auth.aharrison.xyz/api/users/').then(({ data }) => {
